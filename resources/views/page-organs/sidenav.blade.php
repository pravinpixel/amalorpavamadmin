<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="{{ route('home') }}">
            <img alt="Logo" src="{{ asset('asset/img/logo/logo1.jpg') }}" class="w-100 logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('home') ? 'hover showing' :null }}">
                    <span class="menu-link">
                        ...
                        <span class="menu-title" onclick="window.location.href='{{ route('home') }}'">Dashboard</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('staff.staff-index') ? 'hover showing' :null }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title" onclick="window.location.href='{{ route('staff.customer-index') }}'">
                                Staff Management
                                </span>
                                <span class="menu-arrow"></span>
                    </span>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion  {{ Route::is(['master.index','master.users','master.roles']) ? 'hover showing' :null  }}">
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg {{ Route::is(['master.index','master.users','master.roles']) ? 'show' :null  }}">
                        <div class="menu-item">
                            <a class="menu-link {{ Route::is('master.index') ? 'active' : null }}" href="{{ route('master.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link  {{ Route::is('master.users') ? 'active' : null }}" href="{{ route('master.users') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">
                        ...
                        <div class="menu-item">
                            <a class="menu-link  {{ Route::is('master.roles') ? 'active' : null }}" href="{{ route('master.roles') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">
