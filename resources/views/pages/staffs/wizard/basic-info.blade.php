            ...
            <div class="w-100">
                ...
                <div class="row">
                        ...
                        <div class="d-inline-block flex-stack">
                            ...
                            <div class="d-block mt-5 align-items-center cstm-zeed">
                                ...
                                <label class="form-check form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-20px" type="radio" name="communication[]"
                                        value="Male" />
                    ...
                    <div class="col-lg-4 mb-5">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select name="marr_type" class="form-select form-select-lg form-select-solid" data-control="select2"
                            data-placeholder="Select Type" data-allow-clear="true" data-hide-search="true">
                            <option></option>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="row fv-row">
                                            ...
                                            <div class="uppy" id="kt_uppy_5">
                                                <div class="uppy-wrapper">
                                                    <div class="uppy-Root uppy-FileInput-container"><input
                                                            class="uppy-FileInput-input uppy-input-control" style=""
                                                            type="file" name="files[]" multiple=""
                                                            id="kt_uppy_5_input_control"><label
                                                            class="uppy-input-label btn btn-light-primary btn-sm btn-bold"
                                                            for="kt_uppy_5_input_control">Attach files</label></div><span
                                                        class="form-text text-dark">Maximum file size 1MB</span>
                                                </div>
                               ...
                               "
                                                            style="width: 0%;" role="progressbar" aria-valuemin="0"
