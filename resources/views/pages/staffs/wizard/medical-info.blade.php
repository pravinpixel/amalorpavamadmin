                            ...
                            <div class="row">
                                ...
                                <div class="mb-5 col-lg-4 fv-row">
                                    ...
                                    <div class="DA_holder question">
                                        ...
                                        <div class="DA_holder DA_radio_holder d-block mt-5 align-items-center cstm-zeed">
                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                <input class="form-check-input h-20px w-20px radio-btn" type="radio"
                                                    name="question1" id="question1" value="yes" />
                                                <span class="form-check-label fw-bold fl">Yes</span>
                                            </label>
                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                <input class="form-check-input h-20px w-20px radio-btn" type="radio"
                                                    name="question1" id="question1" value="no" />
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="uppy" id="kt_uppy_5">
                                                        <div class="uppy-wrapper">
                                                            ...
                                                            <span class="form-text text-dark">Maximum file size 1MB</span>
                                                        </div>
                            ...
                            <div class="tble-fnton card mt-0 mb-5 mb-xl-8">
                                ...
                                <div class="card-header border-0 pt-0">
                                    ...
                                    <div id="kt_help" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="help"
                                        ...
                                        data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_new_family1_toggle"
                                        data-kt-drawer-close="#kt_help_close">
                                        <!--begin::Card-->
                                        <div class="card shadow-none rounded-0 w-100">
                                            <!--begin::Header-->
                                            <div class="card-header" id="kt_help_header">
                                                <h5 class="card-title fw-bold text-gray-600">Add your Medical Details
                                                    Details</h5>
